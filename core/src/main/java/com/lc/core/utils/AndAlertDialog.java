...
public abstract class AndAlertDialog {
    ...
    private static class Api21Dialog extends AndAlertDialog {
    ...
    private static class Api20Dialog extends AndAlertDialog {
    ...
    private static class APi21Builder implements Builder {
        ...
        @Override
        public AndAlertDialog create() {
            return new Api21Dialog(builder.create());
        }

        @Override
        public AndAlertDialog show() {
            final AndAlertDialog dialog = create();
            dialog.show();
            return dialog;
        }
